...
* **deployable units responsible for offering cybersecurity services to the Marine Transportation System**
* **three core CPT services: Assess, Hunt, Service**


##### **Mission Types**


* **Assess - guidance and recommendations to secure and protect MTS networks**
* **Hunt - discover undetected adversary on MTS before the compromise impacts critical services**
* **Incident Response - advise on mitigation \& remediation, forensic analysis, assistance with integration of FBI, CISA, and others**



##### **DMSS Kit Hardware and Software**



#### **OCEAN Management**

* **backbone infrastructure or the operational network for CPT analysts to conduct data analysis and correlation during mission**
* **Offers threat analysis**
...
* **Change makers**
* **Direct work with the DoD**
* **Education \& Certification Opportunities**
* **Opportunities for all**


### **Cybersecurity Infrastructure Security Agency (CISA) Guest Lecture**
...
* advancing integrated cyber and physical risk management
* developing products and mitigation measures, with a focus on the cascading effects across sectors and lifeline functions
* promoting security and resilience in infrastructure planning and investment
